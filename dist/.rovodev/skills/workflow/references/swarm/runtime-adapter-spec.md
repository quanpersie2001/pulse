...
- ready work selected from `node .rovodev/skills/workflow/scripts/pulse.mjs ready --repo-root <repo> --json`
- graph truth from `.pulse/workgraph/views/graph.json`
- reservation layer from `node .rovodev/skills/workflow/scripts/pulse.mjs reservation ... --repo-root <repo> --json`
