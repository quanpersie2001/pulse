...
```bash
node .rovodev/skills/workflow/scripts/pulse.mjs status --repo-root <repo> --json
```
...
1. Run `node .rovodev/skills/workflow/scripts/pulse.mjs status --repo-root <repo> --json` again.
