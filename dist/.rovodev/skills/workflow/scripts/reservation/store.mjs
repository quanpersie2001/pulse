 ...
 * Caller/flow: Used by cli/reservation.mjs and status aggregation.
 ...
 * Repo root rule: Caller passes repo root; store path is resolved via core/paths.mjs.
 */
...
import { getPulsePaths } from "../core/paths.mjs";
