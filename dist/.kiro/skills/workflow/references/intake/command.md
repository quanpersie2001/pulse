...
```bash
node .kiro/skills/workflow/scripts/pulse.mjs status --repo-root <repo> --json
```
...
1. Run `node .kiro/skills/workflow/scripts/pulse.mjs status --repo-root <repo> --json` again.
