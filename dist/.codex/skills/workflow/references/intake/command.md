...
```bash
node .codex/skills/workflow/scripts/pulse.mjs status --repo-root <repo> --json
```
...
1. Run `node .codex/skills/workflow/scripts/pulse.mjs status --repo-root <repo> --json` again.
