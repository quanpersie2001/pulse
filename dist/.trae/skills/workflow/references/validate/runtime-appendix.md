...
This appendix assumes validate is consuming an approved story-scoped `plan.md` and any approved TASK/BUG work items already materialized through `node .trae/skills/workflow/scripts/pulse.mjs workgraph`.
