...
- ready work selected from `node .trae/skills/pulse:workflow/scripts/pulse.mjs ready --repo-root <repo> --json`
- graph truth from `.pulse/workgraph/views/graph.json`
- reservation layer from `node .trae/skills/pulse:workflow/scripts/pulse.mjs reservation ... --repo-root <repo> --json`
