...
Use this prompt when running the `discovery.md` reviewer after `pulse:workflow explore` to check evidence completeness before downstream design or planning.
