...
```bash
node .opencode/skills/workflow/scripts/pulse.mjs status --repo-root <repo> --json
```
...
1. Run `node .opencode/skills/workflow/scripts/pulse.mjs status --repo-root <repo> --json` again.
