...
```bash
node .claude/skills/workflow/scripts/pulse.mjs status --repo-root <repo> --json
```
...
1. Run `node .claude/skills/workflow/scripts/pulse.mjs status --repo-root <repo> --json` again.
