# Compound Analysis Prompts

Use these prompts for `pulse:workflow compound` Phase 2 subagents when extracting durable learnings from completed work artifacts.

## Agent 1: Pattern Extractor

```text
Read the completed work artifacts provided. Identify all REUSABLE PATTERNS that emerged:
...
- Integration patterns: how this work connected to other systems
...
```text
Read the completed work artifacts provided. Identify all significant DECISIONS made during this work:
...
```text
Read the completed work artifacts provided. Identify all FAILURES, BLOCKERS, and WASTED EFFORT:
