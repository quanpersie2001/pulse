...
Use `node .agents/skills/workflow/scripts/pulse.mjs workgraph ... --json` for workgraph reads and consistency checks. Do not treat generated views or raw JSONL as writable truth. Use [workgraph-model.md](../shared/workgraph-model.md) for dependency, link, owner, reservation, and readiness semantics.
