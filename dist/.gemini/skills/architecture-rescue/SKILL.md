...
- do not create beads
- do not invoke `pulse:workflow plan`
- do not invoke `pulse:workflow execute`
...
- `phase-shaping`: hand off top approved candidate(s) to `pulse:workflow plan`
- `execution-ready`: after validating gate approval, proceed via `pulse:workflow swarm` or `pulse:workflow execute`
