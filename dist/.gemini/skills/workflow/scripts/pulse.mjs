 ...
 * `node .gemini/skills/workflow/scripts/pulse.mjs` operator surface used by agents and humans to inspect runtime posture, find ready work,
 ...
 *
 * Caller/flow: Invoked by rendered `node .gemini/skills/workflow/scripts/pulse.mjs ...` calls from `pulse:workflow` instructions,
