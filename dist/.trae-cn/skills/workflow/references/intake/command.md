...
```bash
node .trae-cn/skills/workflow/scripts/pulse.mjs status --repo-root <repo> --json
```
...
1. Run `node .trae-cn/skills/workflow/scripts/pulse.mjs status --repo-root <repo> --json` again.
