...
- `node .trae-cn/skills/workflow/scripts/pulse.mjs ...` reads and coordinates runtime state through the installed workflow skill.
...
| `node .trae-cn/skills/workflow/scripts/pulse.mjs` | inspect readiness and coordinate reservations through the installed workflow runtime |
