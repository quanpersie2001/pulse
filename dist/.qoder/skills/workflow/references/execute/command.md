...
1. `AGENTS.md`
2. `node .qoder/skills/workflow/scripts/pulse.mjs status --repo-root <repo> --json`
...
- `Next step: node .qoder/skills/workflow/scripts/pulse.mjs ready --repo-root <repo> --json`
...
```bash
node .qoder/skills/workflow/scripts/pulse.mjs ready --repo-root <repo> --json
```
...
```bash
node .qoder/skills/workflow/scripts/pulse.mjs reservation reserve --repo-root <repo> --agent <runtime_identity> --item <item-id> --path "src/foo.ts" --path "src/bar.ts" --json
```
...
```bash
node .qoder/skills/workflow/scripts/pulse.mjs reservation release --repo-root <repo> --agent <runtime_identity> --json
```
...
5. active reservations: `node .qoder/skills/workflow/scripts/pulse.mjs reservation list --repo-root <repo> --active-only --json`
...
| Action | Call |
|---|---|
| List ready items | `node .qoder/skills/workflow/scripts/pulse.mjs ready --repo-root <repo> --json` |
| Read item contract | active workgraph metadata |
| Reserve scope | `node .qoder/skills/workflow/scripts/pulse.mjs reservation reserve --repo-root <repo> --agent <runtime_identity> --item <item-id> --path "..." --json` |
| Release scope | `node .qoder/skills/workflow/scripts/pulse.mjs reservation release --repo-root <repo> --agent <runtime_identity> --json` |
| List active reservations | `node .qoder/skills/workflow/scripts/pulse.mjs reservation list --repo-root <repo> --active-only --json` |
