...
```bash
node .qoder/skills/workflow/scripts/pulse.mjs status --repo-root <repo> --json
```
...
1. Run `node .qoder/skills/workflow/scripts/pulse.mjs status --repo-root <repo> --json` again.
