...
**Planner action:** attach this file in item `memory_hooks.corrections` when the trigger clearly matches.
```
...
**Propagation:** ratchet
**Planner action:** attach this file in item `memory_hooks.ratchet` when the trigger clearly matches.
