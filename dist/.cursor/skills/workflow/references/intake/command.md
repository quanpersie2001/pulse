...
```bash
node .cursor/skills/workflow/scripts/pulse.mjs status --repo-root <repo> --json
```
...
1. Run `node .cursor/skills/workflow/scripts/pulse.mjs status --repo-root <repo> --json` again.
