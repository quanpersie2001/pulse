...
fn preflight_managed_paths(repo_root: &Path) -> Result<()> {
    ...
    for relative in [
        ...
        ".pulse/evidence/schemas/receipt-envelope.schema.json",
        ".pulse/evidence/schemas/receipt-envelope-qa.schema.json",
        ".pulse/evidence/schemas/supersession-reconciliation.schema.json",
        ".pulse/evidence/schemas/shaping-validation.schema.json",
        ".pulse/evidence/schemas/decision-acceptance.schema.json",
        ".pulse/evidence/schemas/documentation-validation.schema.json",
        ".pulse/evidence/schemas/qa-checkpoint.schema.json",
        ".pulse/evidence/schemas/qa-checkpoint-lifecycle.schema.json",
        ".pulse/evidence/schemas/qa-checkpoint-browser.schema.json",
        ".pulse/evidence/schemas/qa-checkpoint-browser-deployment.schema.json",
        ".pulse/docs/registry.json",
        ".pulse/docs/schemas/document.schema.json",
        ".pulse/knowledge/manifest.json",
        ".pulse/knowledge/schemas/learning.schema.json",
        ".pulse/knowledge/schemas/relation.schema.json",
