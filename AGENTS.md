...
This project is indexed by GitNexus as **pulse** (3670 symbols, 5393 relationships, 224 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
