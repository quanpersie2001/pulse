...
This project is indexed by GitNexus as **pulse** (3681 symbols, 5407 relationships, 224 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
