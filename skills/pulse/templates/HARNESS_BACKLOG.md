...
The contract lives in `skills/pulse/references/HARNESS.md`.
...
- Discovered while: `/pulse` with no subcommand
...
- Risk: medium
- Status: new
- Evidence: `skills/pulse/SKILL.md`, `skills/pulse/scripts/command-metadata.json`
...
- Suggested improvement: relocate canonical runtime scripts under `skills/pulse/scripts/runtime/` and materialize the v2 layout under `.pulse/`
- Risk: high
- Status: planned
