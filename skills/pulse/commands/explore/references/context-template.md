...
This template is written by `/pulse explore` in Phase 4.
It is read by `/pulse plan`, `/pulse validate`, and downstream implementation/review phases.
...
- `/pulse plan` consumes locked decisions and open-question partitions
- `/pulse validate` checks that planned checks and artifacts reflect decisions
