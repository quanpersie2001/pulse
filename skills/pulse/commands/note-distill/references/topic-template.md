...
Use this template when creating or normalizing `works/notes/distil/topics/<slug>/<slug>.md`.

**Save to:** `works/notes/distil/topics/<slug>/<slug>.md`
...
updated_at: <ISO-8601>
source_notes:
  - works/notes/raws/YYYYMMDD.md#note-<slug>
