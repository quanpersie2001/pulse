...
| --- | --- | --- | --- |
| Public router | `skills/pulse/` | user-facing workflow contract | `SKILL.md`, command docs, shared references |
...
| Harness reference/template plane | `skills/pulse/references/`, `skills/pulse/templates/` | source docs and seed artifacts owned by the plugin | `HARNESS.md`, `HARNESS_BACKLOG.md` |
...
`skills/pulse/references/HARNESS.md` explains the harness contract.
It is not a runtime seed file.

### Do not treat templates as source-of-truth docs

`skills/pulse/templates/HARNESS_BACKLOG.md` is a seed artifact.
...
They do not replace the router contract in `skills/pulse/`.
