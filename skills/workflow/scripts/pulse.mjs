 ...
 * `{{pulse_command}}` operator surface used by agents and humans to inspect runtime posture, find ready work,
 ...
 *
 * Caller/flow: Invoked by rendered `{{pulse_command}} ...` calls from `pulse:workflow` instructions,
