...
Origin:
- Existing `skills/swarming/SKILL.md`
- Existing `skills/executing/SKILL.md`
...
- `skills/swarming/references/worker-template.md`
...
- `skills/swarming/references/message-templates.md`
